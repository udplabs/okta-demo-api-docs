variable "udp_app" { default = "services-docs" }
...
resource "okta_app_oauth" "demoSpa" {
  ...
  redirect_uris  = ["https://${var.udp_subdomain}.${var.udp_app}.unidemo.info/guide/reset.html"]
...
resource "okta_trusted_origin" "dealer_https" {
  ...
  origin = "https://${var.udp_subdomain}.${var.udp_app}.unidemo.info"
